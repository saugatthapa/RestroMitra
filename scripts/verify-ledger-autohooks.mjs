...
// --- Record an expense (should auto-create a ledger 'expense' entry) ---
await page.goto(`${BASE}/dashboard/expenses`, { waitUntil: "networkidle" });
await page.waitForTimeout(700);
await page.click('button:has-text("+ Add expense"), button:has-text("Add expense")');
await page.waitForTimeout(400);
await page.screenshot({ path: "/tmp/debug-expenses-form.png", fullPage: true });
