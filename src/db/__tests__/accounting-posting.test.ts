...
describe.skipIf(!hasDb)("Accounting — postVoucher (integration)", () => {
  ...
  it("seeds the default chart of accounts and account_mappings idempotently", async () => {
    ...
    // Depreciation Expense"; Slice 5e added "5160 — Interest Expense"; Phase
    // 6, Slice 6a added "1150 — Input VAT Receivable") + the 1 inactive test
    // fixture inserted directly above.
