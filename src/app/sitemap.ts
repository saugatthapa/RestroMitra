...
const STATIC_ROUTES: { path: string; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
  ...
  { path: "/compare/restrokendra-vs-restronp", changeFrequency: "monthly", priority: 0.6 },
  { path: "/compare/restrokendra-vs-recaho", changeFrequency: "monthly", priority: 0.6 },
  { path: "/compare/restrokendra-vs-hamrosan", changeFrequency: "monthly", priority: 0.6 },
  ...
  { path: "/alternatives/restronp", changeFrequency: "monthly", priority: 0.6 },
  { path: "/alternatives/recaho", changeFrequency: "monthly", priority: 0.6 },
  { path: "/alternatives/hamrosan", changeFrequency: "monthly", priority: 0.6 },
